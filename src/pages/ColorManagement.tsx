  ...
  const columns: Column[] = [
    {
      ...
      dataIndex: "MaMau",
      render: (value) => (
        <span className="text-xs bg-gray-100 px-2 py-1 rounded">{value}</span>
      ),
    },
    {
      key: "color",
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setFormData({ ...formData, TenMau: e.target.value })
              }
              required
          ...
          <div>
            ...
            <div className="flex items-center space-x-3">
              <input
                ...
                onChange={(e) =>
                  setFormData({ ...formData, MaHex: e.target.value })
                }
          ...
          <div className="flex justify-end space-x-3 pt-4">
            <button
              ...
              className="px-4 py-2 text-sm text-gray-700 bg-gray-100 rounded-lg border border-gray-300 hover:bg-gray-200 transition-colors duration-150"
            >
              Hủy
            </button>
            <button
              type="submit"
              className="px-4 py-2 text-sm text-white bg-[#8B5C2A] rounded-lg hover:bg-[#8B5C2A] transition-colors duration-500 font-semibold shadow-sm"
            >
