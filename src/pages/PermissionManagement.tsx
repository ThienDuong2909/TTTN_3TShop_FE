...
import { Shield, Users, Key, CheckCircle, XCircle, Edit2, Save, X, Loader2 } from 'lucide-react';
...
export default function PermissionManagement() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (result.success) {
          ...
          toast.success(`Cập nhật quyền cho vai trò "${role.displayName}" thành công!`);
          setEditingRole(null);
          setEditedPermissions([]);
        } else {
  ...
  const getPermissionCategory = (permission: string) => {
    ...
    switch (module) {
      ...
      case 'binhluan': return 'Bình luận';
      case 'giohang': return 'Giỏ hàng';
      case 'nhanvien': return 'Nhân viên';
      case 'hoadon': return 'Hóa đơn';
      case 'nhacungcap': return 'Nhà cung cấp';
      case 'danhmuc': return 'Danh mục';
      case 'mausac': return 'Màu sắc';
      case 'kichthuoc': return 'Kích thước';
      case 'nhaphang': return 'Nhập hàng';
      case 'dathang': return 'Đặt hàng';
      case 'bophan': return 'Bộ phận';
      case 'tigia': return 'Tỷ giá';
      case 'trangthaidonhang': return 'Trạng thái đơn hàng';
      case 'taikhoan': return 'Tài khoản';
      case 'thongtin': return 'Thông tin';
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <Button onClick={fetchRolesAndPermissions} className="bg-blue-600 hover:bg-blue-700">
            Thử lại
          </Button>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="text-center p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                <div className="text-2xl font-bold text-orange-600">
                  {Object.values(roles).filter(role => role.permissions.includes('toanquyen')).length}
                </div>
