...
import Suppliers from "./pages/admin/SupplierManagement";
// import Discounts from './pages/admin/Discounts';
// import Reviews from './pages/admin/Reviews';
import Employees from "./pages/admin/EmployeeManagement";
import Departments from "./pages/admin/Departments";
import Colors from "./pages/admin/ColorManagement";
...
import BestSellerProducts from "./pages/user/BestSellerProducts";

import DiscountProducts from "./pages/user/DiscountProducts";
...
const UserAccountLayoutWrapper = ({
  children,
}: {
      ...
      <AppProvider>
        ...
        <Routes>
          ...
          {/* <Route
            ...
            element={
              <ProtectedRoute
                requiredPermissions={["hoadon.xem", "hoadon.tao"]}
              >
                <AdminLayout>
                  <Invoices />
                </AdminLayout>
          ...
          <Route
            ...
            element={
              <ProtectedRoute
                requiredPermissions={["nhanvien.xem", "nhanvien.phancong"]}
              >
                <AdminLayout>
                  <Employees />
                </AdminLayout>
          ...
          <Route
            ...
            element={
              <ProtectedRoute
                requiredPermissions={["mausac.tao", "mausac.sua", "mausac.xoa"]}
              >
                <AdminLayout>
                  <Colors />
                </AdminLayout>
                ...
                <AdminLayout>
                  <div className="p-6">
                    ...
                    <p className="text-gray-600">
                      Trang quản lý kích thước sản phẩm
                    </p>
                  </div>
                </AdminLayout>
              </ProtectedRoute>
          ...
          <Route
            ...
            element={
              <MainLayout>
                <ProtectedRoute
                  requiredPermissions={["giohang.xem", "donhang.tao"]}
                >
                  <Checkout />
                </ProtectedRoute>
              </MainLayout>
